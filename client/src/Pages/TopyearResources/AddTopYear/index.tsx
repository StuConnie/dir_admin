...
const AddtopYear: React.FC = () => {
    ...
    const eventDelete = async (condition: any) => {
        if(condition === 'YES'){
            ...
            let obj = {
                method: 'POST',
                url: 'https://directory-admin-server1.vercel.app/AddYearTop',
                        ...
                        <div key={ Math.random() } className='p-1'>
                            <div className='min-h-[300px] bg-[#2A2A2C] p-2 flex rounded-md'>
                                ...
                                <div className='w-[55%] p-3 flex content-between flex-wrap'>
                                    <div className='m'>
                                        <p className='text-[#FFF200] text-[17px]  line-clamp-4'>{ a.title }</p>
                                        ...
                                        <p className='text-[#FFF200] text-[17px]  line-clamp-4'>{ a.overview }</p>
